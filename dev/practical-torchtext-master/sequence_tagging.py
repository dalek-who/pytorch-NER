...
train_iter, val_iter = data.BucketIterator.splits(
    (train, val), batch_size=3, device="cpu")
...
embedding = GloVe(name='6B', dim=300) # GloVe(name='6B', dim='300')
WORD.build_vocab(train.word, val.word, test.word, vectors="glove.6B.300d") # [embedding])
